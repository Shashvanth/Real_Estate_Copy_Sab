        ...
        <div className="homepage">
          <nav className="home-navbar">
            <div className="home-navbar-left">
              ...
              <ul className="home-nav-links">
                ...
                <li>
                  <a href="#Properties">Contact Us</a>
                </li>
                <li>
            ...
            <div className="home-navbar-right">
              <button className="auth-button" onClick={goToSignin}>
                Login
              </button>
          ...
          <header className="home-hero">
            <div className="home-hero-content">
              ...
              <br />
              <a href="#Properties" className="home-hero-button">
                Explore Now
              </a>
            </div>
          </header>
        ...
        <div className="footer">
          <div className="footer-content">
            <div className="footer-section">
              ...
              <p>
                Email:{" "}
                <a href="mailto:admin@estatehub.com">admin@estatehub.com</a>
              </p>
              <p>
                Phone: <a href="tel:6374453114">+91 9865655712</a>
              </p>
            </div>
            <div className="footer-section">
              <h2>Follow Us</h2>
            ...
            <div className="footer-section">
              <h2>About Us</h2>
              <p>
                EstateHub is dedicated to bringing you the best plots and houses
                to make your search of houses easy and happy. Join our community
                and enjoy the benifits today!
              </p>
            </div>
          </div>
